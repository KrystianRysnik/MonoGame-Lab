...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        ChooseLevelScreen mChooseLevelScreen;
        ...
        public void MainMenuScreenEvent(Object obj, EventArgs e)
        {
            if (Keyboard.GetState().IsKeyDown(Keys.Enter) & !previousState.IsKeyDown(Keys.Enter))
            {
                ...
                {
                    case 0:
                        mCurrentScreen = mChooseLevelScreen;
                        break;
                    case 1:
                        Exit();
                        break;
        ...
        public void ChooseLevelScreenEvent(Object obj, EventArgs e)
        {
            if (Keyboard.GetState().IsKeyDown(Keys.Enter) & !previousState.IsKeyDown(Keys.Enter))
            {
                switch (mChooseLevelScreen.choose)
                {
                    case 0:
                        mCurrentScreen = mGameScreen;
                        mGameScreen.StartGame(0);
                        break;
                    case 1:
                        mCurrentScreen = mGameScreen;
                        mGameScreen.StartGame(1);
                        break;
                    case 2:
                        mCurrentScreen = mGameScreen;
                        mGameScreen.StartGame(2);
                        break;
                }
            }
        }
